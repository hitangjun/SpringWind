 ...
 */
@Controller
@RequestMapping("/perm/task")
public class CronTaskController extends BaseController {
	...
	private void addSimpleTrigger(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (StringUtils.isEmpty(MapUtils.getString(filterMap, QuartzJobManager.STARTTIME))) {
